---
title: "How to use the STMATREG package"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{How to use the STMATREG package}
...
This package incorporates a linear regression based on the matrix variant skew-t distribution using the asynchronous parallel ECME, regular parallel ECME, and regular non-parallel ECME algorithms.
